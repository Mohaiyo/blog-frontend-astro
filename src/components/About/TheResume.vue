<template>
  <article class="resume" :class="{ active }" data-page="resume">
    <header>
      <h2 class="h2 article-title">简历</h2>
    </header>
    ...
    <section class="skill">
      <h3 class="h3 skills-title">技能</h3>
